...
```bash
claude plugin marketplace add ~/Documents/ws/superpowers-dev/.claude-plugin/marketplace.json
```
...
```bash
claude plugin uninstall superpowers@<marketplace-name>
```
...
```bash
claude plugin update superpowers@superpowers-marketplace-dev
```

## Uninstalling

```bash
claude plugin uninstall superpowers@superpowers-marketplace-dev
